    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6 mb-8">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Tambah Jadwal Ibadah</h1>
                    <p class="text-gray-600 mt-1">Buat jadwal ibadah baru untuk AMGPM Ranting Parthenos</p>
                </div>
            </div>
            <div class="mt-4 flex justify-end">
                <a href="{{ route('ibadah.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors duration-200">
        ...
        <div class="bg-white/90 backdrop-blur-sm p-8 md:p-12 rounded-2xl shadow-2xl border border-white/20">
            <form action="{{ route('ibadah.store') }}" method="POST">
                ...
                <div class="mt-12 flex flex-col sm:flex-row justify-end gap-4">
                    <a href="{{ route('ibadah.index') }}" class="inline-flex items-center justify-center px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl transition-all duration-200 font-medium">
                        <i class="fas fa-times mr-2"></i>
                        Batal
                    </a>
                    <button type="submit" class="inline-flex items-center justify-center px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl transition-all duration-200 font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
