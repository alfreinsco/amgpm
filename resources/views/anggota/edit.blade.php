...
<div class="py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-8 pb-6 border-b border-gray-200">
            <div>
                <h1 class="text-3xl font-extrabold text-blue-900">Edit Anggota</h1>
                <p class="mt-2 text-sm text-gray-500">Edit data anggota: {{ $anggotum->nama }}</p>
            </div>
        ...
        <div class="bg-white p-8 rounded-lg shadow-xl border border-gray-100">
            <form action="{{ route('anggota.update', $anggotum) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" 
                               id="tanggal_lahir" 
                               name="tanggal_lahir" 
                               value="{{ old('tanggal_lahir', $anggotum->tanggal_lahir) }}"
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                    ...
                    <a href="{{ route('anggota.show', $anggotum) }}" class="btn btn-outline flex-1 sm:flex-none">
                        <i class="fas fa-eye mr-2"></i>
                        Lihat Detail
                    </a>
                    <a href="{{ route('anggota.index') }}" class="btn btn-ghost flex-1 sm:flex-none">
