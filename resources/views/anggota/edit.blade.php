...
@section('title', 'Edit Anggota - ' . config('app.name', 'Laravel'))
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6 mb-8">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Edit Anggota</h1>
                    <p class="text-gray-600 mt-1">Edit data anggota: {{ $anggotum->nama }}</p>
                </div>
            </div>
            ...
            <form action="{{ route('anggota.update', $anggotum) }}" method="POST" class="space-y-8">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text"
                           id="whatsapp"
                           name="whatsapp"
                           value="{{ old('whatsapp', $anggotum->whatsapp) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text"
                               id="tempat_lahir"
                               name="tempat_lahir"
                               value="{{ old('tempat_lahir', $anggotum->tempat_lahir) }}"
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="date"
                               id="tanggal_lahir"
                               name="tanggal_lahir"
                               value="{{ old('tanggal_lahir', $anggotum->tanggal_lahir->format('Y-m-d')) }}"
                ...
                <div class="space-y-2">
                    ...
                    <select id="golongan_darah"
                        ...
                        <option value="A" {{ old('golongan_darah', $anggotum->golongan_darah) === 'A' ? 'selected' : '' }}>A</option>
                        <option value="B" {{ old('golongan_darah', $anggotum->golongan_darah) === 'B' ? 'selected' : '' }}>B</option>
                        <option value="AB" {{ old('golongan_darah', $anggotum->golongan_darah) === 'AB' ? 'selected' : '' }}>AB</option>
                        <option value="O" {{ old('golongan_darah', $anggotum->golongan_darah) === 'O' ? 'selected' : '' }}>O</option>
                    </select>
                        ...
                        <div class="flex-1">
                            <label for="is_admin" class="flex items-center cursor-pointer">
                                <input type="checkbox"
                                       ...
                                       {{ old('is_admin', $anggotum->is_admin) ? 'checked' : '' }}>
                ...
                <div class="flex flex-wrap justify-end gap-3 pt-8 border-t border-gray-200">
                    <a href="{{ route('anggota.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-xl text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-200">
                        <i class="fas fa-times mr-2"></i>
                        Batal
                    </a>
                    <a href="{{ route('anggota.show', $anggotum) }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-xl hover:from-indigo-700 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-all duration-200">
                        <i class="fas fa-eye mr-2"></i>
                        Lihat Detail
                    </a>
                    <button type="submit" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform hover:scale-105 transition-all duration-200 shadow-lg">
